<?php if (!is_page('delivery') && !is_page('Home') && !is_page('testimonials') && !is_page('checkout') && !is_page('faq') && !is_page('gallery') && !is_page('interior-design') && !is_page('login') && !is_page('maintenance') && !is_page('terms-and-conditions') && !is_page('My Account') && !is_page('cart') && !is_page('thank-you')): ?>
    <aside id="sidebar">
