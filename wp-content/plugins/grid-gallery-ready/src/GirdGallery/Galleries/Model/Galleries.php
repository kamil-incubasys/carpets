...
/**
 * Class GirdGallery_Galleries_Model_Galleries
 * Provides the logic to work with the galleries
 *
 * @package GirdGallery\Galleries\Model
 * @author Artur Kovalevsky
 */
class GirdGallery_Galleries_Model_Galleries extends GirdGallery_Core_BaseModel
{
    ...
    protected function extend($gallery)
    {
        ...
        $models = array();
        $resources = new GirdGallery_Galleries_Model_Resources($this->debugEnabled);
        $resourcesData = $resources->getByGalleryId($gallery->id);

        $models['settings'] = new GirdGallery_Galleries_Model_Settings($this->debugEnabled);
        ...
        $models['photos'] = new GirdGallery_Photos_Model_Photos($this->debugEnabled);
        $models['folders'] = new GirdGallery_Photos_Model_Folders($this->debugEnabled);
