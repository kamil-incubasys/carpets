...
/**
 * Class GirdGallery_Galleries_Model_Resources
 ...
 */
class GirdGallery_Galleries_Model_Resources extends GirdGallery_Core_BaseModel
{
    /**
     * @var string
     */
     ...
     *
     * @return mixed
     * @throws GirdGallery_Galleries_Exception_AttachException If not enough input data
     */
    public function attachFromRequest(Rsc_Http_Request $request, Rsc_Lang $lang)
    {
        if (!$resources = $request->post->get('resources')) {
            ...
            throw new GirdGallery_Galleries_Exception_AttachException(
