...
/**
 * Class GirdGallery_Colorbox_Module.
 * Registers the Colorbox in the system.
 * @package GirdGallery\Colorbox
 */
class GirdGallery_Colorbox_Module extends Rsc_Mvc_Module
{
     ...
     * @param GirdGallery_Ui_Module $ui The UI Module.
     */
    public function load(GirdGallery_Ui_Module $ui)
    {
        $this->loadPlugin($ui);
        $this->loadLocale($ui);
        $this->loadTheme($ui);
    ...
    public function reload()
    {
        ...
        if (is_object($ui) && $ui instanceof GirdGallery_Ui_Module) {
            $this->load($ui);
     ...
     * @param GirdGallery_Ui_Module $ui The UI Module.
     */
    protected function loadPlugin(GirdGallery_Ui_Module $ui)
    {
        $ui->add(
        ...
        $frontend = new GirdGallery_Ui_Javascript(
     ...
     * @param GirdGallery_Ui_Module $ui The UI Module.
     */
    protected function loadLocale(GirdGallery_Ui_Module $ui)
    {
        $locale = get_locale();
     ...
     * @param GirdGallery_Ui_Module $ui The UI Module.
     */
    protected function loadTheme(GirdGallery_Ui_Module $ui)
    {
        $config = $this->getEnvironment()->getConfig();
        ...
        $ui->add(
            new GirdGallery_Ui_BackendStylesheet(
