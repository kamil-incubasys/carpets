...
/**
 * Class GirdGallery_Photos_Model_Photo
 *
 * @package GirdGallery\Photos\Model
 * @author Artur Kovalevsky
 */
class GirdGallery_Photos_Model_Photos extends Rsc_Mvc_Model
{
     ...
     * @return GirdGallery_Photos_Model_Photos
     */
    ...
    public function getFolderByPhotoId($photoId)
    {
        ...
        if (!class_exists($classname = 'GirdGallery_Photos_Model_Folders', false)) {
        ...
        $folders = new GirdGallery_Photos_Model_Folders($this->debugEnabled);
