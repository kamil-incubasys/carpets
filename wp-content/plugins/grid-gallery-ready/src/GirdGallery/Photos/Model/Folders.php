...
/**
 * Class GirdGallery_Photos_Model_Folders
 * Folders
 *
 * @package GirdGallery\Photos\Model
 * @author Artur Kovalevsky
 */
class GirdGallery_Photos_Model_Folders extends Rsc_Mvc_Model
{
    /**
     * @var string
     */
     ...
     * @return GirdGallery_Photos_Model_Folders
     */
    ...
    {
        if (!class_exists('GirdGallery_Photos_Model_Photos', false)) {
            if ($this->debugEnabled) {
                wp_die(sprintf('The required class \'GirdGallery_Photos_Model_Photos\' is does not exists in method', __METHOD__));
            }

            return null;
        }

        $photos = new GirdGallery_Photos_Model_Photos($this->debugEnabled);
