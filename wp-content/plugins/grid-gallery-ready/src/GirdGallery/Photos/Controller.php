...
/**
 * Class GirdGallery_Photos_Controller
 *
 * @package GirdGallery\Photos
 */
class GirdGallery_Photos_Controller extends GirdGallery_Core_BaseController
{
    ...
    public function addAction(Rsc_Http_Request $request)
    {
        ...
        $photos = new GirdGallery_Photos_Model_Photos();
    ...
    {
        $env = $this->getEnvironment();
        $folders = new GirdGallery_Photos_Model_Folders();
    ...
    public function deleteAction(Rsc_Http_Request $request)
    {
        ...
        $photos = new GirdGallery_Photos_Model_Photos($debug);
        $folders = new GirdGallery_Photos_Model_Folders($debug);
    ...
    public function isEmptyAction()
    {
        ...
        $isEmpty = true;
        $photos = new GirdGallery_Photos_Model_Photos($debugEnabled);
    ...
    public function updateAttachmentAction(Rsc_Http_Request $request)
    {
        ...
        /** @var GirdGallery_Photos_Model_Photos $photos */
        $photos = $this->getModel('photos');
