...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	<title><?php bloginfo('name'); ?> &rsaquo; <?php echo $title; ?></title>
        ...
        <!--<link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/assets/css/login.css" type="text/css" />-->
	<?php
...
function login_footer($input_id = '') {
	...
	<div class="clear"></div>
        <!-- Rest of the custome HTML footer-->
				</section>
			</div>
		</div>
		<footer id="footer">
...
<form class="form" name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
        <div class="col">
                <div class="left">
                    <input type="email" class="email" name="user_login" id="user_login" class="input" value="<?php echo esc_attr($user_login); ?>" size="20" />
                </div>
        </div>
<!--        <p>
...
?>
<form class="form" name="resetpassform" id="resetpassform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=resetpass', 'login_post' ) ); ?>" method="post" autocomplete="off">
...
<!--	<p>
	...
	<p>
        ...
        <div class="col">
                <div class="left">
                        <input type="password" name="pass1" id="pass1" class="input" size="20" value="" autocomplete="off" placeholder="Password*" />
                </div>
        </div>
        <div class="col">
                <div class="left">
                        <input type="password" name="pass2" id="pass2" class="input" size="20" value="" autocomplete="off" placeholder="Password*" />
                </div>
        </div>
...
<form class="form" name="registerform" id="registerform" action="<?php echo esc_url( site_url('wp-login.php?action=register', 'login_post') ); ?>" method="post" novalidate="novalidate">
<!--	<p>
...
<form class="form" name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
<!--	<p>
		<label for="user_login"><?php _e('Username') ?><br />
	...
	<p>
        ...
        <div class="col">
                <div class="left">
                    <input type="text" name="log" id="user_login" class="input" value="<?php echo esc_attr($user_login); ?>" size="20" placeholder="Username" />
                </div>
        </div>
        <div class="col">
                <div class="left">
